  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="../penjualan/datapenjualan.php"><i class="fa fa-book"></i> <span>Data Penjualan</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="addbarang.php" type="button" class="btn btn-success">Add</a>
            </div>
            <?php
            ...
            $result = mysqli_query($mysqli, "SELECT * FROM db_kasirbarang ORDER BY id DESC");
            ?>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                    ...
                    echo "
                      <script>
                        Swal.fire({
                          icon: 'warning',
                          title: 'Stok habis!',
                          text: 'Stok barang " . $data['nm_barang'] . " telah habis! Segera perbarui Stok!'
                        });
                      </script>";
                  }
                  ?>
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a href="editbarang.php?id=<?php echo $data['id'] ?>" class="btn btn-warning">Edit</a>
                      <a href="hapusbarang.php?id=<?php echo $data['id'] ?>" class="btn btn-danger">HAPUS</a>
                    </div>
                  </td>
                </tr>
                <?php
