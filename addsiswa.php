...
<head>
  ...
  <title>SMK Tunas Harapan Pati | Dashboard</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Bahrun Niam</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Bahrun Niam - Web Programmer
                  <small>Nomer Absen 99</small>
                </p>
              </li>
              <!-- Menu Footer-->
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Input Data Siswa</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="addproses.php" method="post" name="form1">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="tgl_lahir" class="form-control" id="tgl_lahit" placeholder="Masukkan Tanggal Lahir">
                </div>
